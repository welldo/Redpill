...
if [ "${repo}" == "pocopico" -a "${branch}" == "develop" ]; then 
  ...
  [ -e redpill-load/config/DS1019+/7.0.1-42218/config.json ] && rm -rf redpill-load/config/DS1019+/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DS1019+/7.0.1-42218/config.json -o redpill-load/config/DS1019+/7.0.1-42218/config.json
  [ -e redpill-load/config/DS1520+/7.0.1-42218/config.json ] && rm -rf redpill-load/config/DS1520+/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DS1520+/7.0.1-42218/config.json -o redpill-load/config/DS1520+/7.0.1-42218/config.json
  [ -e redpill-load/config/DS1520+/7.1.0-42661/config.json ] && rm -rf redpill-load/config/DS1520+/7.1.0-42661/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DS1520+/7.1.0-42661/config.json -o redpill-load/config/DS1520+/7.1.0-42661/config.json
  [ -e redpill-load/config/DS1621xs+/7.0.1-42218/config.json ] && rm -rf redpill-load/config/DS1621xs+/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DS1621xs+/7.0.1-42218/config.json -o redpill-load/config/DS1621xs+/7.0.1-42218/config.json
  [ -e redpill-load/config/DVA3219/7.0.1-42218/config.json ] && rm -rf redpill-load/config/DVA3219/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DVA3219/7.0.1-42218/config.json -o redpill-load/config/DVA3219/7.0.1-42218/config.json
  [ -e redpill-load/config/DVA3219/7.1.0-42661/config.json ] && rm -rf redpill-load/config/DVA3219/7.1.0-42661/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DVA3219/7.1.0-42661/config.json -o redpill-load/config/DVA3219/7.1.0-42661/config.json
  [ -e redpill-load/config/DVA3221/7.0.1-42218/config.json ] && rm -rf redpill-load/config/DVA3221/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DVA3221/7.0.1-42218/config.json -o redpill-load/config/DVA3221/7.0.1-42218/config.json
  [ -e redpill-load/config/DVA3221/7.1.0-42661/config.json ] && rm -rf redpill-load/config/DVA3221/7.1.0-42661/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/DVA3221/7.1.0-42661/config.json -o redpill-load/config/DVA3221/7.1.0-42661/config.json
  [ -e redpill-load/config/FS2500/7.0.1-42218/config.json ] && rm -rf redpill-load/config/FS2500/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/FS2500/7.0.1-42218/config.json -o redpill-load/config/FS2500/7.0.1-42218/config.json
  [ -e redpill-load/config/FS2500/7.1.0-42661/config.json ] && rm -rf redpill-load/config/FS2500/7.1.0-42661/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/FS2500/7.1.0-42661/config.json -o redpill-load/config/FS2500/7.1.0-42661/config.json
  [ -e redpill-load/config/FS6400/7.0.1-42218/config.json ] && rm -rf redpill-load/config/FS6400/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/FS6400/7.0.1-42218/config.json -o redpill-load/config/FS6400/7.0.1-42218/config.json
  [ -e redpill-load/config/RS3413xs+/7.0.1-42218/config.json ] && rm -rf redpill-load/config/RS3413xs+/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/RS3413xs+/7.0.1-42218/config.json -o redpill-load/config/RS3413xs+/7.0.1-42218/config.json
  [ -e redpill-load/config/RS3413xs+/7.1.0-42661/config.json ] && rm -rf redpill-load/config/RS3413xs+/7.1.0-42661/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/RS3413xs+/7.1.0-42661/config.json -o redpill-load/config/RS3413xs+/7.1.0-42661/config.json
  [ -e redpill-load/config/RS3618xs/7.0.1-42218/config.json ] && rm -rf redpill-load/config/RS3618xs/7.0.1-42218/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/RS3618xs/7.0.1-42218/config.json -o redpill-load/config/RS3618xs/7.0.1-42218/config.json
  [ -e redpill-load/config/RS3618xs/7.1.0-42661/config.json ] && rm -rf redpill-load/config/RS3618xs/7.1.0-42661/config.json && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/RS3618xs/7.1.0-42661/config.json -o redpill-load/config/RS3618xs/7.1.0-42661/config.json

  [ -d redpill-load/config/SA6400/7.1.1-42962 -a ! -f redpill-load/config/SA6400/7.1.1-42962/zImage-001-SA6400-42962-ramdisk-and-header.bsp ] && curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-dev/config/SA6400/7.1.1-42962/zImage-001-SA6400-42962-ramdisk-and-header.bsp -o redpill-load/config/SA6400/7.1.1-42962/zImage-001-SA6400-42962-ramdisk-and-header.bsp
...
if [ "${repo}" == "jumkey" -a "${branch}" == "develop" ]; then 
  ...
  if [ -d redpill-load/config/DS920+/7.0.1-42218 ]; then
    ...
    curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-jun/config/DS920+/7.0.1-42218/zImage-001-920p-42218-ramdisk-and-flag-NOP.bsp -o redpill-load/config/DS920+/7.0.1-42218/zImage-001-920p-42218-ramdisk-and-flag-NOP.bsp
    curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-jun/config/DS920+/7.0.1-42218/config.json -o redpill-load/config/DS920+/7.0.1-42218/config.json
  fi
  if [ -d redpill-load/config/DVA3221/7.0.1-42218 ]; then
    rm -rf redpill-load/config/DVA3221/7.0.1-42218/*
    curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-jun/config/DVA3221/7.0.1-42218/zImage-001-dav3221-42218-ramdisk-and-header.bsp -o redpill-load/config/DVA3221/7.0.1-42218/zImage-001-dav3221-42218-ramdisk-and-header.bsp
    curl -sSL https://raw.githubusercontent.com/wjz304/redpill-load/test-jun/config/DVA3221/7.0.1-42218/config.json -o redpill-load/config/DVA3221/7.0.1-42218/config.json
  fi
